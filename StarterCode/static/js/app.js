...
button.on("click", () => {
    ...
    else if (response.filterData.length === 0 && ((response.filterShape.length !== 0 || response.filterCity.length !== 0 || response.filterDate.length !== 0))) {
        populate(filterShape) || populate(filterCity) || populate(filterDate);
    }
    else {
